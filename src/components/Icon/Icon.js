...
export function IconAirbnb() {
    return (
        <div>
            <img src="https://img.icons8.com/color/96/000000/airbnb.png" alt="A"/>
        </div>
    )
}
...
export function IconFacebook() {
    return (
        ...
        <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="100%" height="100%">
            <path
...
export const FacebookIcon = () => (
    <svg
        clipRule="evenodd"
        fillRule="evenodd"
        viewBox="0 0 260.09601 260.09601"
        version="1.1"
        id="svg323"
        width="20"
        height="20"
    ...
    >
        <defs
            id="defs327"/>
        <path
            d="M 260.096,130.048 C 260.096,58.23 201.866,0 130.048,0 58.23,0 0,58.23 0,130.048 0,194.953 47.55,248.757 109.73,258.524 V 167.649 H 76.701 V 130.048 H 109.73 V 101.39 c 0,-32.59 19.422,-50.604 49.122,-50.604 14.228,0 29.115,2.542 29.115,2.542 v 32.005 h -16.405 c -16.148,0 -21.196,10.022 -21.196,20.318 v 24.396 h 36.064 l -5.761,37.601 h -30.304 v 90.875 c 62.18,-9.749 109.73,-63.553 109.73,-128.476 z"
            fill="#1977f3"
            id="path319"/>
        <path
            d="m 180.67,167.648 5.761,-37.601 h -36.064 v -24.396 c 0,-10.278 5.029,-20.318 21.196,-20.318 h 16.405 V 53.328 c 0,0 -14.886,-2.542 -29.115,-2.542 -29.7,0 -49.122,17.996 -49.122,50.604 v 28.658 H 76.702 v 37.601 h 33.029 v 90.875 c 6.62,1.041 13.405,1.572 20.318,1.572 6.913,0 13.698,-0.549 20.318,-1.572 v -90.875 h 30.304 z"
            fill="#fefefe"
            id="path321"/>
    </svg>
)
...
export const AppleIcon = () => (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="presentation" aria-hidden="true"
         focusable="false">
        <path
